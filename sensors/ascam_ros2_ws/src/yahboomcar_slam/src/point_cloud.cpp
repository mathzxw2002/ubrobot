...
PointCloudMapper::PointCloudMapper() : Node("pointcloud_mapping")
{
    ...
    this->declare_parameter<std::string>("topicColor", "/ascamera_hp60c/camera_publisher/rgb0/image");
    this->declare_parameter<std::string>("topicDepth", "/ascamera_hp60c/camera_publisher/depth0/image_raw");
