...
def make_teleoperator_from_config(config: TeleoperatorConfig) -> Teleoperator:
    ...
    if config.type == "keyboard":
        ...
        from .piper.teleoperator import PiperTeleoperator

        return PiperTeleoperator(config)
    elif config.type == "piper_keyboard":
        from .piper.teleop_keyboard import PiperKeyboardTeleop

        return PiperKeyboardTeleop(config)
